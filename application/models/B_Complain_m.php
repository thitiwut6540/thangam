<?php
class B_Complain_m extends CI_Model {
    ...
    function getTypeInsertSave($data){
        ...
        $this->db->trans_begin();
            ...
            $this->db->insert('tb_complain_type', $data1);
    ...
    function getTypeEditSave($data){
        $this->db->trans_begin();
            ...
            $this->db->where('ct_id', $data['ct_id']);
            $this->db->update('tb_complain_type', $data1);
    ...
    function getComplainList($limit, $offset, $search, $count){
        ...
        $condition="a.c_cata='R' AND a.c_status ='".$c_status."' ";
        if($search){
