            ...
            <div class="col-12 p-2 bg_main_light rounded">
                <form id="form_SH" name="form_SH" class="form-inline p-0 m-0">
                    <div class="form-group mx-sm-3">
                        <input type="text" class="form-control form-control-sm" id="SH_status" name="SH_status" value="<?php echo $status;?>" readonly>
                    </div>
                    <div class="form-group mx-sm-3">
                        <input type="text" class="form-control form-control-sm" id="SH_title" name="SH_title" placeholder="ชื่อเรื่อง">
                    </div>
                    <div class="form-group mx-sm-3">
                        <input type="text" class="form-control form-control-sm" id="SH_name" name="SH_name" placeholder="ชื่อผู้แจ้ง">
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function ajaxList(page_url = false){
            var baseurl = '<?php echo base_url("B_Complain/complain_cancel_list"); ?>';
            ...
            $.confirm({
                ...
                buttons: {
                    ลบ: {
                        ...
                        action: function() {
                            $.ajax({
                                url: base_url + "B_Complain/complain_delete",
                                type: 'POST',
                                dataType: "json",
                                data: {c_no: c_no},
                                success: function(data) {
