                                    ...
                                    <div class="border jumbotron p-4">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-6 col-md-2">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="c_status" name="c_status" value="เสร็จสิ้น" readonly>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-12 text-right">
                                                <button type="submit" form="form_insert" class="btn btn-success" id="btn_submit_insert"><i class="fas fa-save"></i> บันทึกเสร็จสินการดำเนินการ</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '.btn_edit_action', function() {
            ...
            $.ajax({
                url: '<?php echo base_url("B_Complain/complain_working_edit"); ?>',
                method: "POST",
                data: {id:id},
                        ...
                        buttons: [
                            {
                                ...
                                click: function(){ 
                                    ...
                                    if (isValid) {
                                        ...
                                        $.ajax({
                                            url: '<?php echo base_url("B_Complain/complain_working_edit_save"); ?>',
                                            type: 'POST',
                                            dataType: "json",
                                            data: formData,
            ...
            $.confirm({
                ...
                buttons: {
                    ลบ: {
                        ...
                        action: function(){
                            $.ajax({
                                url: '<?php echo base_url("B_Complain/complain_action_photo_delete"); ?>',
                                method: "POST",
                                dataType: "json",
                                beforeSend: function() {$('#loader').show();},
                                complete: function() {$('#loader').hide();},
        ...
        $(document).on('click', '#btn_submit_insert', function() {
            ...
            $('#form_insert').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("B_Complain/complain_working_action"); ?>',
                        type: 'POST',
                        dataType: "json",
                        data: formData,
                        beforeSend: function() { $('#loader').show(); },
                            ...
                            if(data.action=='Y'){
                                $.confirm({
                                    ...
                                    buttons: {
                                        ...
                                        ปิด: {
                                            action: function(){
                                                location.href = '<?php echo base_url("backoffice/ร้องเรียนร้องทุกข์/ดำเนินการ");?>';
                                            }
                                        },
                                    }
                                });
