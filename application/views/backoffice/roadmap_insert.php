        ...
        <div class="row">
            <div class="col-12 m-0">
                <div class="box_con mb-5">
                    ...
                    <div class="row">
                            <div class="col-12"><i class="far fa-paper-plane"></i> เพิ่ม<?php echo $type; ?></div>
                        </div>
                    </div>
                            ...
                            <form id="form_insert" name="form_insert">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" id="rm_t_name" name="rm_t_name" class="form-control form-control-sm" value="<?php echo $type;?>" readonly>
                                        <input type="hidden" id="rm_t_id" name="rm_t_id" value="<?php echo $type_id;?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-auto">
                                        <label>วันที่โพส</label><br>
                                        <input type="text" id="rm_date_post" name="rm_date_post" class="form-control form-control-sm dTH" value="<?php echo $this->B_Function_m->dateTha(date("Y-m-d")); ?>">
                                    </div>
                                    <div class="form-group col-auto">
                                        <label>เวลาที่โพส</label><br>
                                        <input type="time" id="rm_time" name="rm_time" class="form-control form-control-sm" value="<?php echo date('H:i'); ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-9">
                                        <label>หัวข้อ <?php echo $type; ?></label>
                                        <textarea id="rm_name" name="rm_name" class="form-control form-control-sm"></textarea>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function(){
            ...
            $('#form_insert').validate({
                ...
                messages: {
                    'rm_f_file[]':{
                        ...
                        filesize: "ไฟล์ขนาดไม่เกิน 20 MB.",
                    }
                },
                submitHandler: function(form) {
                    var formData = new FormData($('#form_insert')[0]);
                    $.ajax({
                        url: '<?php echo base_url("B_Roadmap/roadmap_insert_save"); ?>',
                        type: 'POST',
                        dataType: "json",
                        data: formData,
        ...
        $(document).on('click', '#btn_add_file', function() {
            $.ajax({
                url: '<?php echo base_url("B_Roadmap/roadmap_add_file"); ?>',
                type: 'POST',
                dataType: "json",
                success: function(data) {
                    if(data.action=='Y'){
