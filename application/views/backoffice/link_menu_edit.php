    ...
    <div id="content" class="toggled">    
        <div class="row mb-2">
            <div id="navi" class="col-12">
                ...
                <i class="fas fa-caret-right"></i> แก้ไขปุ่มลิงค์เมนู
            </div>
        </div>
        <div class="row">
            <div class="col-12 m-0">
                <div class="box_con mb-5">
                    <div class="box_con_header">
                        <div class="row">
                            <div class="col-12"><i class="fas fa-bars"></i> แก้ไขปุ่มลิงค์เมนู</div>
                        </div>
                    </div>
                        ...
                        <form id="form_edit" name="form_edit">
                            <div class="form-row">
								<div class="form-group col-8">
                                    <img class="img-fluid" src="<?php echo base_url('public/images/link_menu/'.$row_Re_l->l_photo);?>"/>
                                </div>
                            </div>
							<div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
									<label for="l_photo">เปลี่ยนภาพปุ่มลิงค์เมนู<span class="text-danger">ขนาดภาพกว้าง 320 x 140px.</span></label>
        ...
        $(document).on('click', '#btn_edit', function() {
            $('#form_edit').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("B_Link_menu/linkmenu_edit_save"); ?>',
                        type: 'POST',
                        dataType: "json",
                        data: formData,
