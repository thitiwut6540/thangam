<div class="container-fluid">
    <div id="panel" class="toggled">
        <div id="sidebar">
            <?php $this->load->view('backoffice/news_menu');?>
        </div>
    </div> 
            ...
            <div class="row px-3 mb-1">
                <div class="col-12 p-2 bg_main rounded">
                    <form id="form_SH" name="form_SH" class="form-inline p-0 m-0">
                        ...
                        <div class="form-group mx-sm-3">
                            <input type="text" class="form-control form-control-sm" id="SH_name" placeholder="ชื่อข่าวสาร">
                        </div>
            ...
            <div class="col-12">
                <div class="box_con">
                    <div class="box_con_header">
                        <div class="row">
                            <div class="col-8"><i class="fas fa-newspaper"></i> <?php echo $type; ?></div>
                            <div class="col-4 text-right"><a class="btn btn-sm btn-success" href="<?php echo base_url('backoffice/ข่าวสาร/'.$type.'/insert');?>"><i class="fas fa-plus"></i> เพิ่ม<?php echo $type;?></a></div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function ajaxList(page_url = false){
            var baseurl = '<?php echo base_url("B_News/news_list"); ?>';
            ...
            $.confirm({
                ...
                buttons: {
                    ลบ: {
                        ...
                        action: function() {
                            $.ajax({
                                url: '<?php echo base_url("B_News/news_delete"); ?>',
                                method: "POST",
                                dataType: "json",
            ...
            $.confirm({
                ...
                buttons: {
                    เปลี่ยนสถานะ: {
                        ...
                        action: function() {
                            $.ajax({
                                url: '<?php echo base_url("B_News/news_approve"); ?>',
                                method: "POST",
                                dataType: "json",
