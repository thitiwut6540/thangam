<style>
    ...
    .tb_box th:nth-child(2), td:nth-child(2) { width: 220px; }
                    ...
                    <div class="box_con_header">
                        <div class="row">
                            ...
                            <div class="col-4 text-right">
                                <a class="btn btn_green" id="btn_type_insert"><i class="fas fa-plus"></i> เพิ่ม</a>
...
<script>
    $(document).ready(function() {
        ajaxConTypelist(page_url = false);

        $(document).on('click', ".pagination li a", function(event) {
            var page_url = $(this).attr('href');
            ajaxConTypelist(page_url);
            event.preventDefault();
        });

        function ajaxConTypelist(page_url = false){
            var page = $('#topic').val();
            var baseurl = base_url+"B_Content/Type_list";
