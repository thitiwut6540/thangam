                                ...
                                <div class="col-12">
                                    <div class="border jumbotron p-4">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-12 col-md-3">
                                                <?php 
                                                $ReDP2 = $this->B_Corrupt_m->getDepart($_SESSION[''.ANW_SS.'dp_id']); 
...
<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '.btn_edit_action', function() {
            ...
            $.ajax({
                url: '<?php echo base_url("B_Corrupt/corrupt_working_edit"); ?>',
                method: "POST",
                data: {id:id},
                        ...
                        buttons: [
                            {
                                ...
                                click: function(){ 
                                    ...
                                    if (isValid) {
                                        ...
                                        $.ajax({
                                            url: '<?php echo base_url("B_Corrupt/corrupt_working_edit_save"); ?>',
                                            type: 'POST',
                                            dataType: "json",
                                            data: formData,
        ...
        $(document).on('click', '#btn_submit_insert', function() {
            ...
            $('#form_insert').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("B_Corrupt/corrupt_working_action"); ?>',
                        type: 'POST',
                        dataType: "json",
                        data: formData,
                        beforeSend: function() { $('#loader').show(); },
                            ...
                            if(data.action=='Y'){
                                $.confirm({
                                    ...
                                    buttons: {
                                        ...
                                        ปิด: {
                                            action: function(){
                                                location.href = '<?php echo base_url("backoffice/ร้องเรียนทุจริตและประพฤติมิชอบ/ดำเนินการ");?>';
                                            }
                                        },
                                    }
                                });
