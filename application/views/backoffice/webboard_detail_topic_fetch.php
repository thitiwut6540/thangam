<table class="table table-bordered" width="100%">
    <thead>
        <tr class="table-secondary">
            <th colspan="4"><i class="fas fa-comments"></i> ข้อความแสดงความคิดเห็น หัวข้อหลัก</th>
        </tr>
    </thead>
    <tbody>
        <?php 
            ...
            <tr>
                ...
                <td width="60" align="center">
                    <?php if(!empty($row_Re_ct->wb_p_admin)){ ?>
                        <button type="button" class="btn btn-sm btn-warning btn_edit_comment" data-id="<?php echo $row_Re_ct->wb_p_id; ?>" data-tid="<?php echo $row_Re_ct->wb_t_id; ?>"><i class="fas fa-pencil-alt"></i></button>
                    <?php } else { ?>
                        <button type="button" class="btn btn-sm" disabled><i class="fas fa-pencil-alt"></i></button>
                    <?php } ?>
                </td>
                <td width="60" align="center">
                    <button class="btn btn-sm btn-danger btn_dele_comment" data-id="<?php echo $row_Re_ct->wb_p_id;?>" data-tid="<?php echo $row_Re_ct->wb_t_id;?>"><i class="fas fa-trash-alt"></i></button>
                </td>
            </tr>
        <?php }} else { ?>
            <tr>
