    ...
    <div id="content" class="toggled">    
        <div class="row mb-2">
            <div id="navi" class="col-12">
                ...
                <i class="fas fa-caret-right"></i> ภาพประกาศ 
            </div>
        </div>
        <div class="row">
            <div class="col-12 m-0">
                <div class="box_con mb-5">
                    <div class="box_con_header">
                        <div class="row">
                            <div class="col-8"><i class="fas fa-bullhorn"></i> ภาพประกาศ </div>
                            <div class="col-4 text-right"><a class=" btn-sm btn-success" href="<?php echo base_url('backoffice/ภาพประกาศ/insert');?>"><i class="fas fa-plus"></i> เพิ่ม</a></div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function ajaxList(){
            $.ajax({
                url: '<?php echo base_url("B_Banner_top/banner_list"); ?>',
                method: "POST",
            ...
            $.confirm({
                ...
                buttons: {
                    ลบ: {
                        ...
                        action: function() {
                            $.ajax({
                                url: '<?php echo base_url("B_Banner_top/banner_delete"); ?>',
                                method: "POST",
                                dataType: "json",
                                data: { ban_id: ban_id},
                                success: function(data) {
        ...
        $(document).on('click', '.btn_status', function() {
            ...
            $.ajax({
                url: '<?php echo base_url("B_Banner_top/banner_status"); ?>',
                method: "POST",
                dataType: "json",
        ...
        $(document).on('click', '.btn_down', function() {
            ...
            $.ajax({
                url: '<?php echo base_url("B_Banner_top/banner_no"); ?>',
                method: "POST",
                dataType: "json",
