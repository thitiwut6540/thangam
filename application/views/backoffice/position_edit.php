                            ...
                            <form id="form_edit" name="form_edit">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="dp_id" id="dp_id" class="form-control form-control-sm">
                                                ...
                                                <option value="<?php echo $row_Re_dt->dp_id; ?>" <?php if($row_Re_dt->dp_id == $row_Re_pst->dp_id){echo "selected";}else{echo "";}?>><?php echo $row_Re_dt->dp_name; ?></option>
                                                <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" id="pst_name" name="pst_name" class="form-control form-control-sm" value="<?php echo $row_Re_pst->position_name; ?>">
                                    </div>
                                </div>
                                ...
                                <input type="hidden" id="pst_id" name="pst_id" value="<?php echo $row_Re_pst->position_id; ?>">
                                <input type="hidden" id="topic" name="topic" value="<?php echo $topic; ?>">
                                <input type="hidden" id="action" name="action" value="position-edit">
                            </form>
                    </div>
                </div>
            </div>
