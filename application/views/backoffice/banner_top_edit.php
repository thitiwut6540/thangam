    ...
    <div id="content" class="toggled">    
        <div class="row mb-2">
            <div id="navi" class="col-12">
                ...
                <i class="fas fa-caret-right"></i> แก้ไขภาพประกาศ 
            </div>
        </div>
        <div class="row">
            <div class="col-12 m-0">
                <div class="box_con mb-5">
                    <div class="box_con_header">
                        <div class="row">
                            <div class="col-12"><i class="fas fa-bullhorn"></i> แก้ไขภาพประกาศ </div>
                        </div>
                    </div>
                    <div class="box_con_detail">
                        <form id="form_edit" name="form_edit">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
									<label for="ban_photo">เปลี่ยนภาพประกาศ <span class="text-danger">ขนาดภาพกว้างไม่เกิน 1300 px.</span></label>
        ...
        $(document).on('click', '#btn_edit', function() {
            $('#form_edit').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("B_Banner_top/banner_edit_save"); ?>',
                        type: 'POST',
                        dataType: "json",
                        data: formData,
