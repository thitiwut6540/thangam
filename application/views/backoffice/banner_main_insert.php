    ...
    <div id="content" class="toggled">    
        <div class="row mb-2">
            <div id="navi" class="col-12">
                ...
                <a href="<?php echo base_url('backoffice/สไลด์โชว์');?>" >สไลด์โชว์</a> 
                <i class="fas fa-caret-right"></i> เพิ่มสไลด์โชว์
            </div>
        </div>
        <div class="row">
            <div class="col-12 m-0">
                <div class="box_con mb-5">
                    <div class="box_con_header">
                        <div class="row">
                            <div class="col-12"><i class="far fa-images"></i> เพิ่มสไลด์โชว์</div>
                        </div>
                    </div>
                        ...
                        <form id="form_insert" name="form_insert">
							...
							<div class="form-row">
                                <div class="form-group col-md-6">
									<label for="ban_photo">ภาพสไลด์โชว์ <span class="text-danger">ขนาดภาพกว้าง 1,600 x 475px.</span></label>
							...
							<button type="submit" class="btn btn-success btn-sm" id="btn_insert"><i class="fas fa-save"></i> บันทึก</button>
						</form>
                    </div>
                </div>
            </div>
        ...
        $(document).on('click', '#btn_insert', function() {
            $('#form_insert').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("B_Banner_main/banner_insert_save"); ?>',
                        type: 'POST',
                        dataType: "json",
                        data: formData,
