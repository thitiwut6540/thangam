            ...
            <table class="tb_list" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <?php } else if ($row_Re_c->c_status == 'ไม่รับแจ้ง'){ ?>
                            <div class="alert alert-dark p-2 text-center m-0" role="alert"><?php echo $row_Re_c->c_status; ?></div>
                        <?php } ?>
                    </td>
                    <td valign="top">
                        <?php echo $this->B_Function_m->datethai_sm_time($row_Re_c->c_date); ?>
                    </td>
                    <td valign="top">
                    ...
                    <td valign="top" align="center">
                        <a class="btn btn-sm btn-success p-2" href="<?php echo base_url('backoffice/ร้องเรียนทุจริตและประพฤติมิชอบ/'.$status.'/ดำเนินการ/').$row_Re_c->c_no; ?>"><i class="fas fa-search"></i> ดู/บันทึก</a>
                    </td>
                    <td valign="top" align="center">
                ...
                <?php }} else { ?>
                    <tr><td colspan="8"><div class="alert alert-danger mb-0" role="alert"><i class="fas fa-exclamation-triangle"></i> ขณะนี้ไม่มีรายการ แจ้งร้องเรียนทุจริตและประพฤติมิชอบ ในขณะนี้</div></td></tr>
                <?php } ?>
            </table>
        </div>
    </div>
