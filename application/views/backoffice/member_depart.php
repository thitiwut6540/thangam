        ...
        <div class="row">
            <div class="col-12">
                <div class="box_con">
                    ...
                    <div class="row">
                        <div class="col-8"><i class="fas fa-users"></i> <?php echo "บุคลากร".$depart_name; ?></div>
                        <?php if($type_id==3){ ?>
                        <div class="col-4 text-right"><a class="btn btn-sm btn-success" href="<?php echo base_url('backoffice/บุคลากร/'.$type_name.'/'.$depart_name.'/insert');?>"><i class="fas fa-plus"></i> เพิ่มบุคลากร</a></div>
                        <?php } ?>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_dele', function() {
            ...
            $.confirm({
                ...
                title: 'ลบรายการ',
                content: 'ต้องการบุคลากร '+name+' หรือไม่',
                type: 'red',
                typeAnimated: true,
                boxWidth: '420px',
                useBootstrap: false,
