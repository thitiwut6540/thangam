            ...
            <div class="col-12 m-0">
                <div class="box_con mb-5">
                    ...
                    <div class="row">
                            ...
                            <div class="col-4 text-right"><a class="btn btn_blue" href="<?php echo base_url('Backoffice/หัวข้อข้อมูล/'.$topic.'')?>"><i class="fas fa-list"></i> รายการ</a></div>
                        </div>
                    </div>
                        ...
                        <form id="form_insert" name="form_insert">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="con_type_id" id="con_type_id" class="form-control form-control-sm">
                                            ...
                                            <option value="<?php echo $row_Re_ct->con_type_id; ?>"><?php echo $row_Re_ct->con_type_name; ?></option>
                                            <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-9">
                                    ...
                                    <input type="text" id="con_name" name="con_name" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-9">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-9">
                                    ...
                                    <input type="text" id="con_l_link" name="con_l_link" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="">รายะเอียดเนื้อหา</label>
                                    <textarea id="con_detail" name="con_detail" class="form-control form-control-sm" style="width:900px;" rows="10"><?php if(!empty($row_Re_if->if_detail)){echo $row_Re_if->if_detail;}else{echo "";} ?></textarea>
                                </div>
                            </div>
                            ...
                            <input type="hidden" id="action" name="action" value="con-insert">
                        </form>
                    </div>
                </div>
            </div>
