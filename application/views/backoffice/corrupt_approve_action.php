...
<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '.btn_edit_approve', function() {
            ...
            $.ajax({
                url: '<?php echo base_url("B_Corrupt/corrupt_approve_edit"); ?>',
                method: "POST",
                data: {id:id},
                        ...
                        buttons: [
                            {
                                ...
                                click: function(){ 
                                    $.ajax({
                                        url: '<?php echo base_url("B_Corrupt/corrupt_approve_edit_save"); ?>',
                                        type: 'POST',
                                        dataType: "json",
        ...
        $(document).on('click', '#btn_submit_insert', function() {
            ...
            $('#form_insert').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("B_Corrupt/corrupt_approve_action"); ?>',
                        type: 'POST',
                        dataType: "json",
                        data: formData,
                        beforeSend: function() { $('#loader').show(); },
                            ...
                            if(data.action=='Y'){
                                $.confirm({
                                    ...
                                    buttons: {
                                        ...
                                        ปิด: {
                                            action: function(){
                                                location.href = '<?php echo base_url("backoffice/ร้องเรียนทุจริตและประพฤติมิชอบ/รับเรื่อง");?>';
                                            }
                                        },
                                    }
                                });
