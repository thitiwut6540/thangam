    ...
    <div id="content" class="toggled">    
        <div class="row mb-2">
            <div id="navi" class="col-12">
                ...
                <i class="fas fa-caret-right"></i> เพิ่มภาพแสดงหน้าแรก (POPUP) 
            </div>
        </div>
        <div class="row">
            <div class="col-12 m-0">
                <div class="box_con mb-5">
                    <div class="box_con_header">
                        <div class="row">
                            <div class="col-12"><i class="fas fa-image"></i> เพิ่มภาพแสดงหน้าแรก (POPUP) </div>
                        </div>
                    </div>
                    <div class="box_con_detail">
                        <form id="form_insert" name="form_insert">
							...
							<div class="form-row">
                                <div class="form-group col-md-6">
									<label for="ban_photo">ภาพแสดงหน้าแรก (POPUP) <span class="text-danger">ขนาดภาพกว้างไม่เกิน 1300 px.</span></label>
        ...
        $(document).on('click', '#btn_insert', function() {
            $('#form_insert').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("B_Banner_popup/banner_insert_save"); ?>',
                        type: 'POST',
                        dataType: "json",
                        data: formData,
