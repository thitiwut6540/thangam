    ...
    <div class="col-12">
        <div class="box_con">
            <div class="box_con_header">
                <div class="row">
                    <div class="col-8"><i class="fas fa-envelope text-danger fa-lg"></i> เรื่องที่แจ้ง ร้องเรียนทุจริตและประพฤติมิชอบ</div>
                    <div class="col-4 text-right"></div>
                </div>
            </div>
            <div class="box_con_detail">
                <div class="row mb-2"><div class="col"><b>ข้อมูลผู้แจ้งร้องเรียน</b></div></div>
                <div class="row">
                    <div class="col-12">
