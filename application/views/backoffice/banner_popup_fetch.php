    ...
    <tr class="table-light">
        ...
        <td>
            <div align="center">
                ...
                <?php 
                } if($list!=1 and $list!=$row_Re_m->ban_max){
                ?>
                    <div align="center">
                        <i class="btn_down" data-id="<?php echo $id; ?>" data-no="<?php echo $list; ?>">
                        <i class="fas fa-chevron-circle-down text-danger fa-lg"></i></i>
                ...
                <?php 
                } if($list==$row_Re_m->ban_max AND $list>0){ 
                ?>
                    <div align="center">
                        <i class="btn_up" data-id="<?php echo $id; ?>" data-no="<?php echo $list; ?>">
                        <i class="fas fa-chevron-circle-up text-success fa-lg"></i></i>
        ...
        <td align="center">
            <a class="btn btn-sm btn-warning" href="<?php echo base_url('backoffice/ภาพแสดงหน้าแรก/edit/'.$row_Re_b->ban_id.''); ?>"><i class="fas fa-pencil-alt"></i></a>
        </td>
        <td align="center">
