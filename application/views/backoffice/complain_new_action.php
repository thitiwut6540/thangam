                                ...
                                <div class="col-12">
                                    <div class="border jumbotron p-4">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-12 col-md-3">
                                                <?php 
                                                $ReDP = $this->B_Complain_m->getDepart($_SESSION[''.ANW_SS.'dp_id']); 
        ...
        $(document).on('click', '#btn_submit_insert', function() {
            $('#form_insert').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("B_Complain/complain_new_action"); ?>',
                        type: 'POST',
                        dataType: "json",
                        data: formData,
                            ...
                            if(data.action=='Y'){
                                $.confirm({
                                    ...
                                    buttons: {
                                        ...
                                        ปิด: {
                                            action: function(){
                                                location.href = '<?php echo base_url("backoffice/ร้องเรียนร้องทุกข์/แจ้งเรื่อง");?>';
                                            }
                                        },
                                    }
                                });
